...
contract InvariantsTest is StdInvariant, Test {
    ...
    function setUp() external {
        ...
        // Narrowing down the random function calls by using Handler contract
        // Eg. Do not call redeemCollateral, unless there is collateral to redeem
    ...
    function invariant_gettersShouldNotRevert() public view {
        dscEngine.getLiquidationBonusPercentage();
